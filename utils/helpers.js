 ...
 * @returns {boolean}
 */
const contieneMayusculas = (contrasenia) =>
 ...
 * @returns {boolean}
 */
const contieneMinusculas = (contrasenia) =>
 ...
 * @returns {boolean}
 */
const caracteresConsecutivos = (contrasenia) => {
 ...
 * @returns {boolean}
 */
const numerosConsecutivos = (contrasenia) => {
 ...
 * @returns {boolean}
 */
const cantidadNumeros = (contrasenia) => {
 ...
 * @returns {boolean}
 */
const longitudContrasenia = (contrasenia) => contrasenia.length;
 ...
 * @returns {boolean}
 */
const verificarCaracteresEspeciales = (contrasenia) => {
 ...
 * @returns {boolean}
 */
const verificarContieneCero = (contrasenia) => contrasenia.includes('0');
 ...
 * @returns {boolean}
 */
const verificarContieneEspacios = (contrasenia) =>
